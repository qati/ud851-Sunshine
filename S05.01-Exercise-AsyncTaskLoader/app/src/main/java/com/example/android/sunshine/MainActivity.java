...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private final int LOAD_WEATHERDATA_ID = 333;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(LOAD_WEATHERDATA_ID, null, this);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            dat.putString(LOCATION, SunshinePreferences.getPreferredWeatherLocation(this));
            getSupportLoaderManager().restartLoader(LOAD_WEATHERDATA_ID, dat, this);
            return true;
        }
